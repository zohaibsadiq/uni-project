...
const TopServices = () => {
    return (
        <section className="text-gray-600 bg-[#EEF4ED] pt-6 pb-10 ">
            <div >
                <h1 className="mb-1 text-2xl font-bold text-center text-black"> Our Top Services</h1>
                <p className="mb-5 text-center text-md">Services Hub provides ultimate installations, repairs, maintenance, and grooming services at your doorstep</p>
            </div>
