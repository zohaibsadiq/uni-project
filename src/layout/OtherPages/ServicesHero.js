import serviceHero1 from "../../Assets/ServiceHero1.jpg"; // The original image you referenced
import serviceHero2 from "../../Assets/ServiceHero2.jpg"; // The original image you referenced
import serviceHero3 from "../../Assets/ServiceHero3.jpg"; // The original image you referenced
const ServicesHero = () => {
  return (
      ...
      <div className="container flex flex-col px-5 py-6 mx-auto item lg:flex-row">
        ...
        <div className="flex flex-col items-center mx-auto text-center md:mt-24 lg:flex-grow lg:pr-24 md:pr-16 md:text-left md:mb-0">
          ...
          <p className="text-lg leading-relaxed text-center lg:max-w-md md:my-8 ">
            Your go-to platform for seamless connections between customers and
            skilled technicians. Experience quick, safe, and affordable service
            booking for all your home repair needs. Whether it's plumbing,
            electrical work, or HVAC maintenance.
          </p>
        </div>
                                              {/* Rigth Side */}
